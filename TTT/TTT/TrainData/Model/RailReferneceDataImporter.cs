...
public sealed class RailReferenceDataImporter(TttDbContext database, ILogger<RailReferenceDataImporter> log) : IRailReferenceDataImporter
{
    private static readonly CultureInfo Invariant = CultureInfo.InvariantCulture;
    private const string BplanDateFormat = "dd-MM-yyyy HH:mm:ss";

    public async Task<int> ImportAsync(string corpusPath, string bplanPath, CancellationToken ct)
    {
